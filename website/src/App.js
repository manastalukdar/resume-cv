        ...
        <div className="App">
          ...
          <Row>
            <div id="pdfjsContainer">
              <iframe title="pdfjsIFrame" src={process.env.PUBLIC_URL + '/pdfjs/web/viewer.html?file=' + process.env.PUBLIC_URL + '/resources/' + this.state.pdfFileRaw} width="100%" height="600">PDF resume</iframe>
            </div>
          </Row>
        </div>      
      </Container>
