...
\experienceSubItem{Data Infrastructure, AI/ML Platform}{Dec 2022 - Feb 2024}

\resumeItemListStart
\resumeListItem {Manager of managers. Led org of 6 teams building multi-cloud, distributed data infra PaaS for large-scale AI/ML applications.}
\resumeListItem{Delivered several new initiatives critical for the company, broadly at the intersection of large-scale distributed systems, data infrastructure and machine learning.}
